...
let TransactionController = class TransactionController {
    ...
    async getAllTransactionsByUserEmail(userEmail) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get All Transactions by User ID' }),
    (0, common_1.Get)('getAllByUserEmail/:email'),
    __param(0, (0, common_1.Param)('email')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TransactionController.prototype, "getAllTransactionsByUserEmail", null);
__decorate([
